...
import DropDown from "../icons/chevron-right.svg";
...
const projects = [
  {
    ...
    technology: "React",
    description:
      "A premium website in progress for one of Kerala's emerging solar EPC leaders. Built to reflect trust, quality, and customer-first values.",
  },
  {
    category: "CRM'S",
    ...
    technology: "Vue.js",
    description:
      "A comprehensive CRM solution for real estate agencies to manage leads, properties, and client communications seamlessly.",
  },
  {
    ...
    description:
      "A cross-platform mobile application that helps users track their workouts, nutrition, and progress towards their fitness goals.",
  },
  {
    category: "Software's",
    ...
    technology: "Electron",
    description:
      "Desktop software for warehouse management, providing real-time inventory tracking, order processing, and reporting.",
  },
  {
    ...
    technology: "C++",
    description:
      "A custom-built IoT controller and software suite for home automation, integrating lighting, climate, and security systems.",
  },
];
...
const PortfolioSection = () => {
  ...
  useEffect(() => {
    ...
    tl.to(cardRef.current, { duration: 0.3, ease: "power2.in" }).to(
      cardRef.current,
  ...
  return (
    <div className="w-full bg-[#F3F4F8] font-sora flex flex-col items-center py-8 md:py-20 px-4">
      ...
      <div ref={cardRef} className="w-full max-w-4xl">
        <div
          className="bg-white overflow-hidden mb-8"
            ...
            <div className="flex-1 mt-6">
              <div className="flex flex-col space-y-2 lg:flex-row lg:justify-between lg:items-start lg:space-y-0">
                ...
                <div className="flex items-start justify-start lg:justify-end lg:mt-0">
                  <div
                    className="flex items-center space-x-2 px-0 py-0 lg:px-2 lg:py-1"
                  ...
                  >
                    <div className="hidden md:flex gap-1 mx-4">
                      {currentProject.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-gray-700 text-xs sm:text-sm font-mono px-2 py-1 rounded-md whitespace-nowrap"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div
                      className="bg-gray-200 hover:bg-gray-300 text-gray-700 p-3 transition-colors duration-300 flex items-center"
                      style={{ borderRadius: "12px" }}
                    >
                      <svg
        ...
        <div className="w-full px-4 md:px-8">
          <div className="flex  lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0">
            {/* Description */}
  ...
  key={index}
  onClick={() => handleTabClick(index)}
  className={`w-10 h-2 overflow-visible inline-block ${
    index === activeIndex
      ? "bg-[#19195E] shadow-[0_4px_12px_#19195E]/30"
      : "bg-gray-300 shadow-[inset_0_0_6px_#19195E/60,inset_0_2px_4px_#ffffff/90]"
  }`}
...
/>
              ...
              <div className="flex space-x-3">
                <button
                  onClick={handlePrev}
                  className="bg-gray-200 shadow-[inset_0_2px_4px_#19195E]/10 border border-zinc-400/30 hover:bg-gray-300 text-gray-700 p-3 transition-colors duration-300 flex items-center space-x-2"
                  style={{ borderRadius: "12px" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
